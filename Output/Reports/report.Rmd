...
To clarify the patterns, the model was used to predict survival data for the two species exposed to a range of chloride concentrations (0 - 3 g chloride), for 0-10 days. The predictions assume a collection temperature of 10°C and a collection date in mid-March.
